...
@app.cell
def _(num_cols_no_id, test, train):
    print("\n" + "=" * 60)
...
def _(target, train):
    ...
    n_outliers = train.filter(
        (train["Premium Amount"] < lower) | (train["Premium Amount"] > upper)
    ).shape[0]
